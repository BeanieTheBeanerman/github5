...
divBlock.innerHTML = `
    <img class="city" src="https://fastly.picsum.photos/id/405/1400/800.jpg?hmac=4CRI7OpfDWtP4EydVd4Z-1NKSGhBmpZq8OaEXVu3be8" alt="img"/> `;
...
let resultsHTML = renderCards(results).join("");
